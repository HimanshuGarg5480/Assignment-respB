...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#9dd4ed]">
      <div className="w-full max-w-md bg-[#2F667F] p-8 rounded-lg shadow-lg text-center">
        <img
          src={Logo}
          alt="Track.io Logo"
        ...
        <div className="my-4 flex items-center">
          ...
          <p className="mx-2 text-white font-medium">or</p>
          <div className="w-1/2 border-b border-gray-300"></div>
        </div>
        <Button
